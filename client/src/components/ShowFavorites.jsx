...
export default function ShowFavorites({ setShowFavorites, showFavorites }) {
  const showFavoritesClass = {
    active:
      "w-24 hover:bg-cadet dark:hover:bg-iron text-white bg-zinc-600 press top-[2px] shadow-none rounded-lg bg-zinc-800 h-16 mr-2",
    inactive:
      "w-24 hover:bg-cadet dark:hover:bg-iron text-white h-16 rounded-lg bg-zinc-600 press mr-2",
  };
