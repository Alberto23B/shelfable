...
export default function Alert() {
  ...
  const style = {
    open: "absolute bottom-2 block w-5/6 p-4 mb-4 mx-auto border-2 border-white leading-5 rounded-lg opacity-100 font-regular bg-gradient-to-tr from-cream-100 to-cream-200 dark:bg-gradient-to-tr dark:from-cadet dark:to-black dark:text-white",
    closed: "hidden",
  };
