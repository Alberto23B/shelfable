...
export default function Results({ data, isLoading, favorites, setFavorites }) {
  ...
  return (
    <>
      <div className="mt-16 md:min-h-[50vh] flex gap-2 flex-row py-4 flex-wrap items-center justify-center bg-cream-100 lg:w-[80vw] rounded-lg overflow-auto min-h-[40vh] max-h-[75vh] md:max-h-full display-results dark:bg-cadet">
